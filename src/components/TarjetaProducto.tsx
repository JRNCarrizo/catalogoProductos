...
export function TarjetaProducto({ producto, enCarrito, onAgregar, onRestar, onVerDetalle }: Props) {
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-2xl border border-white/8 bg-gradient-to-b from-noche-850 to-noche-900 [content-visibility:auto] [contain-intrinsic-size:auto_30rem] lg:transition lg:duration-300 lg:hover:-translate-y-1 lg:hover:border-oro-400/30 lg:hover:shadow-[0_24px_48px_-24px_rgba(0,0,0,0.9)]">
      <button
        type="button"
